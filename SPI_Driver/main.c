...
void main (void){
DIO_VidSetPortDirection(PORTD_NUM ,OUTPUT);
	DIO_VidSetPinDirection(PORTA_NUM,PIN7_NUM,OUTPUT);
	DIO_VidSetPinDirection(PORTA_NUM,PIN6_NUM,OUTPUT);
	DIO_VidSetPinDirection(PORTA_NUM,PIN5_NUM,OUTPUT);
...
DIO_VidSetPinValue(PORTA_NUM,PIN7_NUM,LOW);
	...
	DIO_VidSetPortValue(PORTD_NUM,Global);
